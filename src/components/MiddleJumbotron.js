...
const MiddleJumbotron = () => {
    return (
        <div className="lg:col-start-3 lg:col-end-5 absolute lg:static row-span-full grid grid-cols-2 grid-rows-4 place-self-center lg:place-self-auto min-[425px]:top-0">
